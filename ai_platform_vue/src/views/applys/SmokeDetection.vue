  ...
  <div>
    <div class="apply_description">
      <div class="apply_description_container">
        <div class="apply_description_name">烟雾检测</div>
        <div class="apply_description_detail">检测是否有烟雾，返回有烟雾的概率</div>
      </div>
    </div>
    <el-upload
      class="upload-demo"
...
export default {
  ...
  methods: {
    ...
    takePhoto(){
      ...
      this.$axios.post('/api/apply/smoke_detection',{base64Data:base64Data}).then(res=>{
        this.stop=false; //开始下一次拍摄上传
        this.confidences='有烟雾的概率：'+res.data.data.confidences+'%';
